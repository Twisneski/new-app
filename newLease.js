...
var newLeaseForm = forms.create({
  newLeaseName: forms.fields.string({
    required: true
  }),
...
function renderForm(req,res,locals){
  res.render('newLease', extend({
    title: 'New Lease',
    csrfToken: req.csrfToken(),
    newLeaseName: req.user.newLeaseName,
...
module.exports = function newLease(){
  ...
  router.all('/', function(req, res) {
    newLeaseForm.handle(req,{
      success: function(form){
        ...
        req.user.newLeaseName = form.data.newLeaseName;
